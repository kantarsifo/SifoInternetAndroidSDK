...
The framework will now send a tag to the server with the information you provided using a background
thread.
...
If necessary, one could use tools to monitor network traffic, such as Charles Proxy or Fiddler, to
