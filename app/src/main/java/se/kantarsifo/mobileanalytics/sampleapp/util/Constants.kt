...
object Constants {
    ...
    const val PANELIST_TRACKING_ONLY_PREFERENCE = "panelist_tracking_only"
    const val LOG_ENABLED_PREFERENCE = "log"
    const val IS_WEB_VIEW_BASED_PREFERENCE = "is_web_view_based"
}